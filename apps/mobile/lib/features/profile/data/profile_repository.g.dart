...
const ownProfileProvider = OwnProfileProvider._();
...
String _$ownProfileHash() => r'18fd8971d15284ac63037bdbfc2224ea08b67be5';

@ProviderFor(activeCategories)
const activeCategoriesProvider = ActiveCategoriesProvider._();
...
final class ActiveCategoriesProvider
  ...
  const ActiveCategoriesProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
